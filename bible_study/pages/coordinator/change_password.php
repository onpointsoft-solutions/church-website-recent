...
// File: pages/coordinator/change_password.php
// Description: Allow coordinators to change their password
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        if ($user && password_verify($current_password, $user['password'])) {
            ...
            if ($update_stmt->execute([$hashed_password, $user_id])) {
                ...
                error_log("Password changed for coordinator ID: $user_id at " . date('Y-m-d H:i:s'));
            } else {
